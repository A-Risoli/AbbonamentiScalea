...
class ImportDialog(QDialog):
    ...
    def validate_data(self):
        ...
        def validation_progress(current, total):
            ...
            self.progress_label.setText(
                f"Validazione: {current}/{total_rows} righe..."
            )
    ...
    def copy_to_clipboard(self, text: str):
        ...
        QMessageBox.information(
            self, "Copiato", "Errori copiati negli appunti!"
        )
    ...
    def import_data(self):
        ...
        if not self.validated_data:
            QMessageBox.warning(
                self, "Errore", "Nessun dato validato da importare."
            )
            return
        ...
        self.progress_label.setText(f"Importazione in corso...")
        self.progress_bar.setMaximum(total_steps)
